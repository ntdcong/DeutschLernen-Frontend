<template>
  <div class="relative flex h-auto min-h-screen w-full flex-col bg-background-light dark:bg-background-dark">
    ...
    <!-- Main Content -->
    <main 
      class="flex flex-1 flex-col justify-center px-4 py-5 outline-none" 
      tabindex="0" 
              ...
              <Transition :name="transitionName" mode="out-in">
                ...
                >
                  <div class="flashcard-inner h-full w-full duration-500">
                    <!-- Front Side -->
                    <div class="flashcard-front absolute inset-0 flex flex-col items-center justify-center rounded-xl border border-black/10 bg-white p-6 shadow-lg backface-hidden dark:border-white/10 dark:bg-text-dark/10 overflow-hidden select-none">
                      <div class="flex flex-col items-center justify-center w-full h-full gap-4 px-4">
                        <h1 
                          class="text-center font-semibold w-full wrap-text"
                    ...
                    >
                      <div class="flex flex-col items-center justify-center w-full flex-1 gap-2 overflow-y-auto px-4">
                        ...
                        <div class="mt-1 space-y-1 text-text-light/80 dark:text-text-dark/80 w-full" :style="getMetaTextStyle()">
