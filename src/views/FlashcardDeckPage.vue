  ...
  <div class="relative flex min-h-screen w-full bg-background-light dark:bg-background-dark">
    ...
    <main class="flex-1 p-4 pt-16 text-text-primary-light sm:p-6 lg:p-8 lg:pt-8 dark:text-text-primary-dark">
      <div class="mx-auto max-w-6xl">
        ...
        <!-- Filters Bar -->
        <div class="mb-8 flex flex-col gap-4 rounded-2xl bg-surface-light p-4 shadow-sm dark:bg-surface-dark sm:flex-row sm:items-center">
          <div class="relative flex-grow">
            <span class="material-symbols-outlined pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-text-secondary-light dark:text-text-secondary-dark">
              search
            </span>
            <input
              v-model="searchQuery"
        ...
        <!-- Error State -->
        <div v-else-if="deckStore.error" class="rounded-xl bg-red-50 p-6 text-center text-red-600 dark:bg-red-900/20 dark:text-red-400">
        ...
        <div v-else class="space-y-12">
          ...
          <div>
            <div class="mb-6 flex items-center gap-3">
              ...
              <span class="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-bold text-gray-600 dark:bg-gray-800 dark:text-gray-400">
                {{ userDecks.length }}
              </span>
            </div>
            
            <div v-if="userDecks.length === 0" class="flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-border-light bg-surface-light py-16 text-center dark:border-border-dark dark:bg-surface-dark">
              ...
              <p class="mt-2 max-w-sm text-sm text-text-secondary-light dark:text-text-secondary-dark">
                {{ searchQuery ? 'Thử tìm kiếm với từ khóa khác xem sao.' : 'Tạo bộ từ vựng đầu tiên để bắt đầu hành trình học tập của bạn!' }}
              </p>
              <button
                v-if="!searchQuery"
                @click="showCreateModal = true"
            ...
            <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              >
                ...
                <div class="flex flex-grow flex-col p-5 pt-0">
                  <div class="-mt-10 mb-3 flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-md dark:bg-gray-800">
                  ...
                  <div class="mb-4 flex items-center gap-2 text-sm text-text-secondary-light dark:text-text-secondary-dark">
          ...
          <div v-if="publicDecks.length > 0">
            <div class="mb-6 flex items-center gap-3">
              <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400">
              ...
              >
                <div class="h-24 bg-black p-4">
                   <div class="flex justify-start">
                      <span class="rounded-full bg-white/20 px-2 py-0.5 text-[10px] font-bold text-white backdrop-blur-sm">
                        OFFICIAL
                      </span>
                   </div>
                </div>
            ...
            <form @submit.prevent="handleCreateDeck">
              <label class="flex flex-col">
                ...
                <input
                  ...
                  placeholder="VD: Từ vựng A1 - Gia đình"
                  type="text"
                />
              </label>
